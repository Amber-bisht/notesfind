...
function NoteCard({ note }: { note: any }) {
    return (
        <Link href={`/${note.subCategoryId?.slug}/${note.slug}`} className="group bg-card border rounded-xl overflow-hidden hover:shadow-lg transition-all h-full flex flex-col">
